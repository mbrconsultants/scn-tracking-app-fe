                  ...
                  <div className="action-section text-center">
                    ...
                    {selectedFile?.lastTracking?.status_id === 2 ? (
                      <div className="rejected-status p-4 rounded-3" style={{
                        ...
                        <i className="fas fa-times-circle text-danger me-2" style={{ fontSize: '2rem' }}></i>
                        <h4 className="text-danger fw-bold mb-2">File Rejected</h4>
                        <p className="text-dark mb-0">
                          This file has been rejected and cannot be forwarded or modified.
                        </p>
                        {selectedFile?.lastTracking?.remark && (
                          <div className="mt-3 p-2 rounded" style={{ background: 'rgba(0,0,0,0.05)' }}>
                            <strong>Reason:</strong> {selectedFile.lastTracking.remark}
                          </div>
                        )}
                      </div>
                    ) : 
                      ...
                      <>
                        {selectedFile?.lastTracking?.status_id === 1 ? (
                          ...
                          <div className="not-assigned-message p-3 rounded-3" style={{
                            ...
                            <span className="text-dark fw-semibold">No actions available for current file status</span>
                          </div>
                        )}
                      </>
                    ) : (
